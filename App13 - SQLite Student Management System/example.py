...
class AgeCalculator(QWidget):
    # We overwrite the __init__ method of QWidget father class
    def __init__(self):
        super().__init__() # We cal the parent, QWidget, to not overwrite
        ...
        date_birth_label = QLabel("Date of Birth MM/DD/YYY: ")
        self.date_birth_line_edit = QLineEdit()
            # self.date_birth_line_edit so we convert it into an instance variable
            # and we can access it from calculate_age method
        ...
        grid.addWidget(calculate_button, 2, 0, 1, 2) # last 1 2 mean to expand across 1 row and 2 columns
